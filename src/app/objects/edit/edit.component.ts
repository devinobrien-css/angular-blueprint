...
export class EditComponent {
  ...
  ngOnInit() {
    ...
    this.http.get(`http://127.0.0.1:5000/objects/${this.id}`).subscribe(data => {
  ...
  onSubmit() {
    ...
    try {
      this.http.patch(`http://127.0.0.1:5000/objects/${this.id}`, {
  ...
  onDelete() {
    try {
      this.http.delete(`http://127.0.0.1:5000/objects/${this.id}`).subscribe(() => {
